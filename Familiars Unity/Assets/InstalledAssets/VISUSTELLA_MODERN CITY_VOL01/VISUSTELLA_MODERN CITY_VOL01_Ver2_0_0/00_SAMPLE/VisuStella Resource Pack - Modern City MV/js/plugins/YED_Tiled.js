	...
	var TiledTilemap = exports.TiledTilemap = function (_ShaderTilemap) {
	    ...
	    _createClass(TiledTilemap, [{
	        ...
	        value: function _createLayers() {
	            ...
	            try {
	                for (var _iterator3 = this.tiledData.layers[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	                    ...
	                    if (!!(0, _helpers.getProperty)(properties, 'zIndex')) {
	                        zIndex = parseInt((0, _helpers.getProperty)(layerData.properties, zIndex));
	                    }

	                    if (!!(0, _helpers.getProperty)(properties, 'collision')) {
	                        id++;
	                        continue;
	                    }

	                    if (!!(0, _helpers.getProperty)(properties, 'toLevel')) {
	                        id++;
	                        continue;
	                    }

	                    if (!!(0, _helpers.getProperty)(properties, 'regionId')) {
	                        id++;
	                        continue;
	                    }
	        ...
	        value: function _isReflectLayer(layerData) {
	            var properties = layerData.properties;
	            return !!properties && ((0, _helpers.getProperty)(properties, 'reflectionSurface') || (0, _helpers.getProperty)(properties, 'reflectionCast'));
	        }
	    }, {
	        key: '_hackRenderer',
	        ...
	        value: function _getPriority(layerId) {
	            ...
	            if (!(0, _helpers.getProperty)(layerData.properties, 'priority')) {
	                return 0;
	            }
	            return parseInt((0, _helpers.getProperty)(layerData.properties, 'priority'));
	        }
	    }, {
	        key: '_isPriorityTile',
	        ...
	        value: function _getZIndex(layerId) {
	            ...
	            if (!layerData.properties || !(0, _helpers.getProperty)(layerData.properties, 'zIndex')) {
	                return 0;
	            }
	            return parseInt((0, _helpers.getProperty)(layerData.properties, 'zIndex'));
	        }
	    }, {
	        key: 'hideOnLevel',
	        value: function hideOnLevel(level) {
	            ...
	            try {
	                for (var _iterator16 = this._layers[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
	                    ...
	                    var layerData = this.tiledData.layers[layer.layerId];
	                    if (layerData.properties && (0, _helpers.getProperty)(layerData.properties, 'hideOnLevel') !== null) {
	                        if (parseInt((0, _helpers.getProperty)(layerData.properties, 'hideOnLevel')) !== level) {
	                            this.addChild(layer);
	                            continue;
	                        }
...
/***/ function(module, exports) {
	...
	var getProperty = exports.getProperty = function getProperty(properties, propertyName) {
	    if (!properties) {
	        return null;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	Game_Map.prototype.isSaveEventLocations = function () {
	    ...
	    return !!(0, _helpers.getProperty)(this.tiledData.properties, 'saveEventLocations');
	};
	...
	Game_Map.prototype._getTileProperties = function (tileId) {
	    ...
	    return tileset.tiles.find(function (tile) {
	        return tile.id === tileId - tileset.firstgid;
	    }).properties || [];
	};
	...
	Game_Map.prototype._setupCollisionFull = function () {
	    ...
	    try {
	        for (var _iterator3 = this.tiledData.layers[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	            ...
	            if (!properties || !(0, _helpers.getProperty)(properties, 'collision')) {
	                continue;
	            }

	            var collision = (0, _helpers.getProperty)(properties, 'collision');

	            if (collision !== "full" && collision !== "up-left" && collision !== "up-right" && collision !== "down-left" && collision !== "down-right" && collision !== "tile-base") {
	                continue;
	            }

	            var level = parseInt((0, _helpers.getProperty)(properties, 'level')) || 0;
	                ...
	                for (var _iterator4 = Array(size).keys()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	                    ...
	                    if (!!layerData.data[x]) {
	                        ...
	                        if (collision === "tile-base") {
	                            ...
	                            if ((0, _helpers.getProperty)(tileproperties, 'collision') === "full") {
	                                ids.push(realX);
	                                if (this.isHalfTile()) {
	                                    ids.push(realX + 1, realX + width, realX + width + 1);
	                                }
	...
	Game_Map.prototype._setupCollisionArrow = function () {
	    ...
	    try {
	        for (var _iterator7 = this.tiledData.layers[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
	            ...
	            if (collision !== "arrow" && collision !== "tile-base") {
	                continue;
	            }
	            ...
	            try {
	                for (var _iterator8 = Array(size).keys()[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
	                    ...
	                    if (collision === "tile-base") {
	                        var tileproperties = this._getTileProperties(layerData.data[x]);
	                        var tilearrowImpassable = (0, _helpers.getProperty)(tileproperties, 'arrowImpassable');
	                        ...
	                        var arrowImpassable = (0, _helpers.getProperty)(properties, 'arrowImpassable');
	                        if (!arrowImpassable) {
	                            continue;
	                        }
	...
	Game_Map.prototype._setupRegion = function () {
	    ...
	    try {
	        for (var _iterator9 = this.tiledData.layers[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
	            ...
	            var properties = layerData.properties;
	            var regionId = (0, _helpers.getProperty)(properties, 'regionId');
	            ...
	            try {
	                for (var _iterator10 = Array(size).keys()[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
	                    ...
	                    if (regionId === "tile-base") {
	                        var tileproperties = this._getTileProperties(layerData.data[x]);
	                        var tileregionId = (0, _helpers.getProperty)(tileproperties, 'regionId');
	                        if (!!tileregionId) {
	...
	Game_Map.prototype._setupMapLevelChange = function () {
	    ...
	    try {
	        for (var _iterator11 = this.tiledData.layers[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
	            ...
	            var properties = layerData.properties;
	            var toLevel = parseInt((0, _helpers.getProperty)(properties, 'toLevel'));
	...
	Game_Map.prototype._setupReflection = function () {
	    ...
	    try {
	        for (var _iterator13 = this.tiledData.layers[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
	            ...
	            var reflectionCast = (0, _helpers.getProperty)(properties, 'reflectionCast');
	            var reflectionMask = (0, _helpers.getProperty)(properties, 'reflectionMask');
	            var reflectionOpacity = (0, _helpers.getProperty)(properties, 'reflectionOpacity') || 255;
	            var reflectionOffset = (0, _helpers.getProperty)(properties, 'reflectionOffset') || 0;
	        ...
	        for (var _iterator17 = this.tiledData.layers[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
	            ...
	            try {
	                for (var _iterator18 = layerData.objects[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
	                    ...
	                    var eventId = parseInt((0, _helpers.getProperty)(object.properties, 'eventId'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReflectionMask = __webpack_require__(81);

	var _Sprite_CharacterReflect = __webpack_require__(82);
